    ...
    socialLinks: [
      {
        ...
        ariaLabel: `KUN (KUN1007's GitHub Home Page)`,
      },
      {
        icon: {
        ...
        ariaLabel: `KUN Visual Novel Telegram Group. Galgame Telegram 群`,
      },
      {
        icon: {
        ...
        ariaLabel: `The CUTEST Visual Novel Forum!世界上最萌的 Galgame 论坛. Topic, Technique. NO ADs Forever. Free Forever. 话题发布, 技术交流, 永远没有广告, 永远免费`,
      },
      {
        icon: {
        ...
        ariaLabel: `鲲 Galgame QQ 群, KUN Visual Novel Group`,
      },
      {
        icon: {
        ...
        ariaLabel: `鲲 Galgame Bilibili 主页, 鲲 Galgame Offical Account`,
      },
    ],
